...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_userprofile', 'tagline', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.tagline'
        db.alter_column(u'users_userprofile', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'tagline': ('django.db.models.fields.TextField', [], {'default': "'A work in progress.'"}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
