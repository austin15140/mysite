...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.isTrainer'
        db.delete_column(u'users_userprofile', 'isTrainer')

        # Adding field 'UserProfile.is_PersonalTrainer'
        db.add_column(u'users_userprofile', 'is_PersonalTrainer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.isTrainer'
        db.add_column(u'users_userprofile', 'isTrainer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UserProfile.is_PersonalTrainer'
        db.delete_column(u'users_userprofile', 'is_PersonalTrainer')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_PersonalTrainer': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
