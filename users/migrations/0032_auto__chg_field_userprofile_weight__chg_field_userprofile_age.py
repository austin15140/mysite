...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_userprofile', 'weight', self.gf('django.db.models.fields.IntegerField')(default=10))

        # Changing field 'UserProfile.age'
        db.alter_column(u'users_userprofile', 'age', self.gf('django.db.models.fields.IntegerField')(default=10))
