...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_userprofile', 'weight', self.gf('django.db.models.fields.CharField')(max_length='3', null=True))

        # Changing field 'UserProfile.age'
        db.alter_column(u'users_userprofile', 'age', self.gf('django.db.models.fields.CharField')(max_length='2', null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.weight'
        db.alter_column(u'users_userprofile', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'UserProfile.age'
        db.alter_column(u'users_userprofile', 'age', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'age': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': "'2'", 'null': 'True', 'blank': 'True'}),
            ...
            'weight': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': "'3'", 'null': 'True', 'blank': 'True'})
        }
    }
