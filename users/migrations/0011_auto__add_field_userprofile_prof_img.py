...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.prof_img'
        db.add_column(u'users_userprofile', 'prof_img',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.prof_img'
        db.delete_column(u'users_userprofile', 'prof_img')
