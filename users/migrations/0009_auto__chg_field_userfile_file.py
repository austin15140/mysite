...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserFile.file'
        db.alter_column(u'users_userfile', 'file', self.gf('django.db.models.fields.files.FileField')(default='file', max_length=100))

    def backwards(self, orm):

        # Changing field 'UserFile.file'
        db.alter_column(u'users_userfile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
