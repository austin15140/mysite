...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'users_userprofile', 'tagline',
                      self.gf('django.db.models.fields.CharField')(default='A work in progress.', max_length=255),
                      keep_default=False)


        # Changing field 'UserProfile.description'
        db.alter_column(u'users_userprofile', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'UserProfile.tagline'
        db.delete_column(u'users_userprofile', 'tagline')


        # Changing field 'UserProfile.description'
        db.alter_column(u'users_userprofile', 'description', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'tagline': ('django.db.models.fields.CharField', [], {'default': "'A work in progress.'", 'max_length': '255'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'}),
