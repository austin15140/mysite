...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.user_age'
        db.delete_column(u'users_userprofile', 'user_age')

        # Adding field 'UserProfile.age'
        db.add_column(u'users_userprofile', 'age',
                      self.gf('django.db.models.fields.IntegerField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.weight'
        db.add_column(u'users_userprofile', 'weight',
                      self.gf('django.db.models.fields.IntegerField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.user_age'
        db.add_column(u'users_userprofile', 'user_age',
        ...
        db.delete_column(u'users_userprofile', 'weight')
