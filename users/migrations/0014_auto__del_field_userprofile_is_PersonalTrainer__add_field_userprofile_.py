...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.is_Personal_Trainer'
        db.add_column(u'users_userprofile', 'is_Personal_Trainer',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.is_Personal_Trainer'
        db.delete_column(u'users_userprofile', 'is_Personal_Trainer')
